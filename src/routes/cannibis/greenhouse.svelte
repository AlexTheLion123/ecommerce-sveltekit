<script lang="ts">
	...
	const items = [
		...
		{ strain: 'Title', description: 'This is the item description bla bla bla bla bla', price: Math.round(Math.random()*1000), stars: Math.round(Math.random()*100)/10, numReviews: Math.round(Math.random()*1000), imgSrc: "/src/lib/assets/images/greenhouse/bud2.jpeg", deadline: new Date("2/29/28"), special: 15},
		{ strain: 'Title', description: 'This is the item description bla bla bla bla bla', price: Math.round(Math.random()*1000), stars: Math.round(Math.random()*100)/10, numReviews: Math.round(Math.random()*1000), imgSrc: "/src/lib/assets/images/greenhouse/bud2.jpeg", deadline: new Date("1/26/22"), special: 0},
		{ strain: 'Title', description: 'This is the item description bla bla bla bla bla', price: Math.round(Math.random()*1000), stars: Math.round(Math.random()*100)/10, numReviews: Math.round(Math.random()*1000), imgSrc: "/src/lib/assets/images/greenhouse/bud2.jpeg", deadline: new Date("1/26/22"), special: 0},
		{ strain: 'Title', description: 'This is the item description bla bla bla bla bla', price: Math.round(Math.random()*1000), stars: Math.round(Math.random()*100)/10, numReviews: Math.round(Math.random()*1000), imgSrc: "/src/lib/assets/images/greenhouse/bud2.jpeg", deadline: new Date("1/26/22"), special: 0},
		{ strain: 'Title', description: 'This is the item description bla bla bla bla bla', price: Math.round(Math.random()*1000), stars: Math.round(Math.random()*100)/10, numReviews: Math.round(Math.random()*1000), imgSrc: "/src/lib/assets/images/greenhouse/bud2.jpeg", deadline: new Date("1/26/22"), special: 0},
